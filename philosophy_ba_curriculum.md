...
```mermaid
flowchart TD
    A["Lower Division Foundation (9 Credits)"] --> B["Core History Sequence (12 Credits)"]
    B --> C["Core Areas & Non-Western (9 Credits)"]
    C --> D["Advanced Elective & Capstone (6 Credits)"]

    subgraph "Lower Division"
        A1["PHIL 109: Formal Logic"]
        A2["PHIL 101: Intro to Philosophy"]
        A3["PHIL 104: Moral Philosophy"]
    end

    subgraph "Core History"
        B1["PHIL 140: Ancient Philosophy"]
        B2["PHIL 141: Medieval Philosophy"]
        B3["PHIL 143: Modern Phil I (Descartes-Hume)"]
        B4["PHIL 144: Modern Phil II (Kant-Nietzsche)"]
    end

    subgraph "Core Areas & Non-Western"
        C1["PHIL 118: Non-Western Philosophy"]
        C2["PHIL 160: Philosophy of Science"]
        C3["PHIL 270: Political Philosophy"]
    end

    subgraph "Advanced & Capstone"
        D1["PHIL 201: 20th Century Analytic Philosophy"]
        D2["PHIL 383: Senior Thesis / Capstone Project"]
    end
```
...
* **Supplementary Textbook**: [Fundamental Methods of Logic](https://milwaukee.pressbooks.pub/fundamentallogic/) by Matthew Knachel ([UWM Institutional Edition](https://dc.uwm.edu/phil_facbooks/1/))
